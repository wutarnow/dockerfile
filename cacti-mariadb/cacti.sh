...
mysql -u root -proot -e "GRANT ALL ON cacti.* TO cactiuser@localhost IDENTIFIED BY 'cactiuser';"
mysql -u root -proot -e "GRANT SELECT ON mysql.time_zone_name TO cactiuser@localhost;"
